        ...
        <div class="row">
            <div class="column">
                <div style="align-content: center">
                    <form>
                        <label>
                            <img class="thumbnail" src="img/beautiful-flowers" onclick="addSup(this)"/>
                        </label>
                        <label>
                            <img class="thumbnail" src="img/frame.png" onclick="addSup(this)"/>
                        </label>
                        <label>
                            <img class="thumbnail" src="img/8.png" onclick="addSup(this)"/>
                        </label>
                        <label>
                            <img class="thumbnail" src="img/wow.png" onclick="addSup(this)"/>
                        </label>
                        <label>
                            <img class="thumbnail" src="img/colour.png" onclick="addSup(this)"/>
                        </label>
                        <label>
                            <img class="thumbnail" src="img/16.png" onclick="addSup(this)"/>
                        </label>
                    </form>
                    <div id="frme">
                        <img src="" id="superimg" alt="" width="540px" height="380px" />
                        <img src="<?php echo $file_n;?>" id="img_upload" alt="" width="540px" height="380px" />
                    </div>
                    <div style="">
                ...
                <canvas id="canvas" height="380px" width="540px" style="display: none"></canvas>
            </div>
            <div class="column">
                <h1>Preview</h1>
                <?php
